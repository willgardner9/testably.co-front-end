<template>
  <div class="w-full flex flex-col items-center justify-center relative mt-8">
    <div
      class="w-full add-first-abtest rounded h-24 flex justify-center relative"
    >
      <h3
        class="
          flex
        ...
        "
      >
        Please choose a plan to start A/B testing!
      </h3>
